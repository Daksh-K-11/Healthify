...
class ProfilePage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      error: (err, stack) =>
          Center(child: Text('Error loading profile: ${err.toString()}')),
    ));
  }
}
          ...
          child: ZoomIn(
            child: ListView(
              children: [
                ...
                ProfileTile(title: "Drinking", value: profile['drinking']),
                ProfileTile(
                    title: "Exercise", value: profile['exercise_hours']),
                ProfileTile(title: "Sleep", value: profile['sleeping_hours']),
              ],
            ),
          ),
        ),
